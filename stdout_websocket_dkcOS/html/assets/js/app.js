...
var tapcontrol= 84;
	...
	socket.on('std_data', function(msg) {
		  ...
		  if (-1!=msg.indexOf("GestSingleFingerSlideRight")) {
			  ges=rightcontrol;
//			  ges="1r";
			}
		  else if (-1!=msg.indexOf("GestSingleFingerSlideLeft")) {
			  			  ges=leftcontrol;

//			  ges="1l";
		  }
		  else if (-1!=msg.indexOf("GestSingleFingerSlideDown")) {
			  			  			  ges=downcontrol;

//			  ges="1d";
		  }
		  else if (-1!=msg.indexOf("GestSingleFingerSlideUp")) {
			  			  			  ges=upcontrol;
...
//			  ges="1u";
		  ...
		  else if (-1!=msg.indexOf("GestSingleFingerDoubleClick")) {
		  }
		  else if (-1!=msg.indexOf("GestSingleFingerTripleClick")) {
		  }
		  else if (-1!=msg.indexOf("GestTwoFingerSlideUp")) {
		  ...
		  else if (-1!=msg.indexOf("GestTwoFingerSlideLeft")) {
			  			   ges=lockcontrol;
